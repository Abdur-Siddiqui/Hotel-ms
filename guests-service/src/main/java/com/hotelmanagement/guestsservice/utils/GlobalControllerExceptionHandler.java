package com.hotelmanagement.guestsservice.utils;
...
public class GlobalControllerExceptionHandler {
    ...
    public HttpErrorInfo handleDuplicateEmailAddressExceptionNotSupportedException(WebRequest request, Exception ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }

    @ResponseStatus(UNPROCESSABLE_ENTITY)
    @ExceptionHandler(InvalidInputException.class)
    public HttpErrorInfo handleUnprocessableEntityException(WebRequest request, Exception ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }
