...
public class RoomServiceClient {
    ...
    public RoomsResponseModel[] getRooms(){
        try {
            //List<VehicleRoomsResponseModel> vehicleRoomsResponseModelList = new ArrayList<>();
            RoomsResponseModel[] roomsResponseModels = restTemplate
                    .getForObject(ROOM_SERVICE_BASE_URI, RoomsResponseModel[].class);

           /* for (VehicleRoomsResponseModel vehicleRoomsResponseModel:
                 vehicleRoomsResponseModels) {
                vehicleRoomsResponseModelList.add(vehicleRoomsResponseModel);
            }*/
